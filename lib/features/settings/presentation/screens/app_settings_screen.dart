                ...
                child: Column(
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items: const [
                        DropdownMenuItem(value: '999', child: Text('999 - MERCANCIA APARTADA')),
                        DropdownMenuItem(value: 'CA', child: Text('CA - CANCUN')),
                        DropdownMenuItem(value: 'CA1', child: Text('CA1 - CANCUN EXHIBICION')),
                        DropdownMenuItem(value: 'CA2', child: Text('CA2 - CANCUN EQUIPOS A PRUEBA')),
                        DropdownMenuItem(value: 'CA3', child: Text('CA3 - CANCUN LABORATORIO')),
                        DropdownMenuItem(value: 'CA4', child: Text('CA4 - CANCUN AREA DE AJUSTE')),
                        DropdownMenuItem(value: 'COCZ', child: Text('COCZ - CONSIGNACION CANCUN ZICOR')),
                        DropdownMenuItem(value: 'COPZ', child: Text('COPZ - CONSIGNACION PUEBLA ZICOR')),
                        DropdownMenuItem(value: 'INT', child: Text('INT - INTERNACIONAL')),
                        DropdownMenuItem(value: 'MEE', child: Text('MEE - MEXICO PROYECTOS ESPECIALES')),
                        DropdownMenuItem(value: 'PU', child: Text('PU - PUEBLA BINEX')),
                        DropdownMenuItem(value: 'SI', child: Text('SI - SILAO BINEX')),
                        DropdownMenuItem(value: 'XCA', child: Text('XCA - REFRIGERATION X CANCUN')),
                        DropdownMenuItem(value: 'XPU', child: Text('XPU - REFRIGERATION X PUEBLA')),
                        DropdownMenuItem(value: 'XZRE', child: Text('XZRE - REFACCIONES REFRIGERATION X')),
                        DropdownMenuItem(value: 'ZRE', child: Text('ZRE - REFACCIONES')),
                      ],
                      onChanged: (value) {
